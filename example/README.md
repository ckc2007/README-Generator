...
A command line README generator that takes user input and formats it.

## Description

- It helps to make README creation easier. 
...
![a command line readme generator](none "a command line readme generator")
